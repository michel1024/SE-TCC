...
<meta http-equiv="Content-Type" content="text/html; charset=windows-1252" />
	...
	<link rel="stylesheet" href="/sites/pwa/IniciativasTest/SiteAssets/css/Material.css"> </link>
   	<link rel="stylesheet" href="http://localhost:1234/Iniciativa.css"> </link>
    
   
   <!--  <link rel="stylesheet" href="/sites/SharedServiceCenter/Style Library/style/itemSearch.css"> -->


    <meta http-equiv="X-UA-Compatible" content="IE=10" />
    <SharePoint:CssRegistration Name="default" runat="server"/>

    <SharePoint:SPShortcutIcon runat="server" IconUrl="https://www.millicom.com/ChildrensDay/img/millicom-favicon32px.png"/>
...
<script type="text/javascript" src="/_layouts/15/autofill.js"></script>    
    <script type="text/javascript" src="/sites/procurement/compass/SiteAssets/Initiative_Tracker/js/jquery.min.js"></script>
    <script type="text/javascript" src="/sites/procurement/compass/SiteAssets/Initiative_Tracker/js/kendo.all.min.js"></script>

    
    <script type="text/javascript" src="/sites/ElSalvadorSD/Style Library/js/pnp.bunble.min.js"></script>

 
  <script src="http://localhost:1234/Iniciativa.js "></script>
  <script src="https://cdnjs.cloudflare.com/ajax/libs/jszip/2.4.0/jszip.js"></script>
   <!--   <script  type="text/javascript" src="/sites/ElSalvadorSD/Style Library/js/Negocio/Aprovals.js"></script>   -->
